...
exports.run = (client, message, args) => {
    ...
    if (!game) return message.reply('Lütfen Steamde Olan Bir Oyunun Adını Yazın. Örnek: `!steamfiyat Oyun ismi veya uygulama ismi`')
...
exports.help = {
  ...
  usage: 'steamfiyat Oyun ismi veya uygulama ismi'
};